# 참고문헌 (References, IEEE Style)

> 본 파일은 본문 작성과 함께 인용된 문헌을 IEEE 양식으로 일괄 정리한다.
> 학위논문지침 양식 (저자, "논문제목", 잡지이름(밑줄/이탤릭), 권 호, pp. 면수, 발간년도) 일치.
> 한국어 문헌은 가나다순, 영어 문헌은 abc순으로 정렬 (또는 본문 인용 순).
> 본 초안은 *본문 인용 순* 으로 정렬한다.

---

[1] L. Thomas, J. Crook, and D. Edelman, *Credit Scoring and Its Applications*, 2nd ed., Philadelphia: SIAM, 2017.

[2] FICO, "What's in My FICO Scores", *FICO Score Education*, 2023. [Online]. Available: https://www.myfico.com
...
[4] S. Ö. Arik and T. Pfister, "TabNet: Attentive interpretable tabular learning", *Proceedings of the AAAI Conference on Artificial Intelligence*, vol. 35, no. 8, pp. 6679-6687, 2021.

[5] 금융위원회·금융감독원, "금융 분야 AI 가이드라인", 2021년 7월. [Online]. Available: https://www.fsc.go.kr

[6] S. M. Lundberg and S.-I. Lee, "A unified approach to interpreting model predictions", *Advances in Neural Information Processing Systems 30 (NIPS 2017)*, pp. 4765-4774, 2017.

[7] OpenAI, J. Achiam, et al., "GPT-4 Technical Report", *arXiv preprint arXiv:2303.08774*, 2023.

[8] P. Lewis, E. Perez, A. Piktus, et al., "Retrieval-augmented generation for knowledge-intensive NLP tasks", *Advances in Neural Information Processing Systems 33 (NeurIPS 2020)*, pp. 9459-9474, 2020.

[9] F. Kamiran and T. Calders, "Data preprocessing techniques for classification without discrimination", *Knowledge and Information Systems*, vol. 33, no. 1, pp. 1-33, 2012.

[10] D. J. Hand and W. E. Henley, "Statistical classification methods in consumer credit scoring: a review", *Journal of the Royal Statistical Society Series A*, vol. 160, no. 3, pp. 523-541, 1997.

[11] Home Credit Group, "Home Credit Default Risk", *Kaggle Competition*, 2018. [Online]. Available: https://www.kaggle.com/c/home-credit-default-risk

[12] H. Hofmann, "Statlog (German Credit Data)", *UCI Machine Learning Repository*, 1994. [Online]. Available: https://archive.ics.uci.edu/ml/datasets/statlog+(german+credit+data)
